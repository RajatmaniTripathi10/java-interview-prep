...
public class EvenMax {
    public static void main(String[] args) {
        List<Integer> lst=List.of(23, 45, 67, 12, 34, 56, 78);
        System.out.println("Original List : "+lst);
        System.out.println("Max Even number : "+findMax(lst));
    }
    public static int findMax(List<Integer> lst){
        if(lst==null){
            return 0;
        }
        return lst.stream().filter(n->n%2==0).reduce((a,b)->a>b?a:b).orElse(0);
    }
}
